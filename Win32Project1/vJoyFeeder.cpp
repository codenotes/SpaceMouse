...
#pragma comment( lib, "..\\vJoyFeederSDK\\lib\\VJOYINTERFACE" )
#define  _CRT_SECURE_NO_WARNINGS

char tempout[512];
#define LOG(X, ...) {sprintf(tempout,X, __VA_ARGS__); OutputDebugString(tempout);}
...
*/
 ...
 void setButtonData(int button, bool state, UINT iInterface = 1)
 {
	...
	int res = SetBtn(state, iInterface, button);
...
int __cdecl _tmain_(__in int argc, __in PZPWSTR argv)
{
